    ...
    async function load() {
      ...
      if (supabase) {
        ...
        if (user && data) {
          ...
          setCanManagePhoto(appRoles.some((role) => ["super_admin", "church_clerk", "secretary"].includes(role)) || data.profile_id === user.id);
        }
      } else {
