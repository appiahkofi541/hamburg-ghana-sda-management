...
export function UserAccessManagement() {
  ...
  function openInvite() {
    if (!invitationsConfigured) {
      setNotice("");
      setError("Invite User is disabled until SUPABASE_SERVICE_ROLE_KEY is configured in Vercel.");
      return;
    }
    setShowInvite(true);
  }
