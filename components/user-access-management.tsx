...
export function UserAccessManagement() {
  ...
  return <div className="space-y-6">
    ...
    {!invitationsConfigured && <p className="rounded-lg bg-amber-50 px-4 py-3 text-sm leading-6 text-amber-800">Role editing, deactivation, and reset links are active. To send new Auth invitations, add <strong>SUPABASE_SERVICE_ROLE_KEY=your-service-role-key</strong> to <strong>.env.local</strong>, save it, and restart the preview server. Do not use <strong>NEXT_PUBLIC_</strong> for this key.</p>}
