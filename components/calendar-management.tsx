    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <div className="divide-y divide-slate-100">{filtered.map((event) => {
          ...
          const canRegister = hasMember && isPublished;
