  ...
  useEffect(() => {
    async function loadEvents() {
      ...
      if (supabase) {
        ...
        const [{ data: departmentRows }, { data: settingRows }, { data }] = await Promise.all([
