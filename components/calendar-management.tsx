...
export function CalendarManagement() {
  ...
  async function registerForEvent(event: CalendarEvent) {
    ...
    console.log("Event registration submit", { currentMember: memberId, eventId: event.id, eventStatus: event.status });
    try {
